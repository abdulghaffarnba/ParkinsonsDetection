...
# sound = parselmouth.Sound("ParkinsonsDetection/Audio/readText_healthy.wav")
...
sound = parselmouth.Sound("ParkinsonsDetection/Audio/healthy.wav")
...
print([localJitter_list, localabsoluteJitter_list, rapJitter_list, ppq5Jitter_list, localShimmer_list,
